...
class FinalAnswerAction(Action):
    system_prompt = "You are a final answer generator. You task is to take the query and context,and generate a precise answer using ONLY the context"
    ...
    def execute(self, schema: FinalAnswerInputSchema) -> FinalAnswerOutputSchema:
        return FinalAnswerOutputSchema(result=get_completion(schema.query,schema.provider,schema.context,system_prompt))
